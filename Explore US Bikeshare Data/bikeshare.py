...
def get_filters():
    ...
    while True:
        city = input("Please enter city (Chicago, New York City, Washington) that you would like to see the data "
                     "from: \n").lower()
        if city.lower() == "chicago" or "new york city" or "washington":
            break
        else:
    ...
    for i in range(1, 13):
        months_choices.append(calendar.month_name[i].lower())

    while True:
        month = input("Please enter month (January, February, ... , June)  or all for no filter: \n").lower()
        if month.lower() in months_choices or month.lower() == "all":
            break
        else:
    ...
    days_choices = []
    for i in range(0, 7):
        days_choices.append(calendar.day_name[i].lower())

    while True:
        day = input("Please enter day of week (all, Monday, Tuesday, ... Sunday) or all for no filter: \n").lower()
        if day.lower() in days_choices or day.lower() == "all":
            break
        else:
...
def station_stats(df):
    ...
    print('\nMost Commonly used combination of start station and end station trip:', popular_combination[0], " and ",
